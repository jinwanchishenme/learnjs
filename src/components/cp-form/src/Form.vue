<script>
  ...
  export default {
    ...
    render(h) {
      return this.wrapForm(h, [this.$slots.default, h('c-row', { staticClass: 'fields-box' }, this.renderItems(h, this.items))])
    }
  }
</script>
